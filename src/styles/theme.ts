...
export const lightTheme = {
  ...
  color: {
    ...
    background_start_gradation: `linear-gradient(to bottom, #FFFFFF, #cfbeff, #a5f1f6, #FFFFFF)`,
...
export const darkTheme = {
  ...
  color: {
    ...
    background_start_gradation: `linear-gradient(to bottom, #1E1B1A, #B096FA,  #cfbeffbb, #a5f1f6dd)`,
