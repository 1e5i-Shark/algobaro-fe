        ...
        <S.HomeMain>
          <S.MainSection>
            <div>
              <S.SectionUpperArea>
                <S.UpperAreaWrapper>
                  <S.SectionTitle>방 제목입니다</S.SectionTitle>
                  <Icon>
                    <LockRoundedIcon />
                  </Icon>
                </S.UpperAreaWrapper>
                <S.SectionLimit>1/6</S.SectionLimit>
              </S.SectionUpperArea>
              <S.SectionBelowArea>
                <Tag
                  mode="normal"
